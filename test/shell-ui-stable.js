(function(){
  ...
  const BUILD=(()=>{
    try{
      ...
      return window.LOG_TEST_BUILD||new URL(script?.src||location.href).searchParams.get('v')||'0.31.10-test.120';
    }catch(_){return window.LOG_TEST_BUILD||'0.31.10-test.120';}
  })();
