...
function renderSettingsPage() {
  ...
  const controlBody = `<div class="check-row settings-toggle-row"><input id="swipeDeleteEnabled" type="checkbox" ${state.settings.swipeDeleteEnabled!==false?'checked':''}><label for="swipeDeleteEnabled"><strong>Verwijderen met swipe</strong><small>Bewerken blijft altijd mogelijk. Staat verwijderen uit, dan blijft Archiveren beschikbaar.</small></label></div>`;
