(function(){
  ...
  function decorateSettingsActions(){
    ...
    const hint='Swipe links: kort voor Bewerken, verder voor Archiveer/Verwijder. Ongebruikte thema’s worden direct verwijderd; gebruikte thema’s worden gearchiveerd.';
