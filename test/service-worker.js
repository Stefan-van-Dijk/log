const CACHE='kmreg-test-shell-0.31.10-test.111';
const SHELL=[
  './',
  './index.html',
  './log-json-v2.js?v=2.0.0',
  './log-ui.css?v=0.31.10-test.111',
  './removal-policy.js?v=0.31.10-test.111',
  './shell-backup-archive.js?v=0.31.10-test.111',
  './shell-ui.js?v=0.31.10-test.111',
  './shell-ui-stable.js?v=0.31.10-test.111',
  './shell-gestures.js?v=0.31.10-test.111',
  './shell-location-status.js?v=0.31.10-test.111',
  './shell-removal-policy.js?v=0.31.10-test.111',
  './shell-quick-actions.js?v=0.31.10-test.111',
  './shell-direct-actions.js?v=0.31.10-test.111',
  './id-converter.html',
  './manifest.webmanifest',
  './app-icon.svg',
  './config/modules.json',
  './time/index.html',
  './time/filter-model.js?v=0.31.10-test.111',
  './time/app.js?v=0.31.10-test.111',
  './time/styles.css?v=0.31.10-test.111',
  './time/home-layout.css?v=0.31.10-test.111',
  './time/home-layout.js?v=0.31.10-test.111',
  './time/home-top.css?v=0.31.10-test.111',
  './time/home-top.js?v=0.31.10-test.111',
  './time/removal-policy-ui.js?v=0.31.10-test.111'
];
