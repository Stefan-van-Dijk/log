const CACHE='kmreg-test-shell-0.31.10-test.120';
const SHELL=[
  './',
  './index.html',
  './swipe-policy.js?v=0.31.10-test.120',
  './swipe-ui.css?v=0.31.10-test.120',
  './cards.css?v=0.31.10-test.120',
  './log-code.js?v=0.31.10-test.120',
  './cards.js?v=0.31.10-test.120',
  './vendor/qrcode-2.0.4.js',
  './vendor/jsbarcode-3.12.1.min.js',
  './vendor/zxing-0.21.3.min.js',
  './log-json-v2.js?v=2.0.0',
  './log-ui.css?v=0.31.10-test.120',
  './removal-policy.js?v=0.31.10-test.120',
  './shell-backup-archive.js?v=0.31.10-test.120',
  './shell-ui.js?v=0.31.10-test.120',
  './shell-ui-stable.js?v=0.31.10-test.120',
  './shell-gestures.js?v=0.31.10-test.120',
  './shell-location-status.js?v=0.31.10-test.120',
  './shell-removal-policy.js?v=0.31.10-test.120',
  './shell-quick-actions.js?v=0.31.10-test.120',
  './shell-direct-actions.js?v=0.31.10-test.120',
  './id-converter.html',
  './manifest.webmanifest',
  './app-icon.svg',
  './config/modules.json',
  './time/index.html',
  './time/filter-model.js?v=0.31.10-test.120',
  './time/app.js?v=0.31.10-test.120',
  './time/styles.css?v=0.31.10-test.120',
  './time/home-layout.css?v=0.31.10-test.120',
  './time/home-layout.js?v=0.31.10-test.120',
  './time/home-top.css?v=0.31.10-test.120',
  './time/home-top.js?v=0.31.10-test.120',
  './time/removal-policy-ui.js?v=0.31.10-test.120'
];
