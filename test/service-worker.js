const CACHE='kmreg-test-shell-0.33.3';
const SHELL=[
  './',
  './index.html',
  './swipe-policy.js?v=0.33.3',
  './swipe-ui.css?v=0.33.3',
  './cards.css?v=0.33.3',
  './log-code.js?v=0.33.3',
  './cards.js?v=0.33.3',
  './people.js?v=0.33.3',
  './location-actions.js?v=0.33.3',
  './location-actions.css?v=0.33.3',
  './contact-import.js?v=0.33.3',
  './people.css?v=0.33.3',
  ...
  './log-ui.css?v=0.33.3',
  './removal-policy.js?v=0.33.3',
  './shell-backup-archive.js?v=0.33.3',
  './shell-ui.js?v=0.33.3',
  './shell-ui-stable.js?v=0.33.3',
  './shell-gestures.js?v=0.33.3',
  './shell-location-status.js?v=0.33.3',
  './shell-removal-policy.js?v=0.33.3',
  './shell-quick-actions.js?v=0.33.3',
  './shell-direct-actions.js?v=0.33.3',
  './id-converter.html',
  './manifest.webmanifest',
  './app-icon.svg',
  './config/modules.json',
  './time/index.html',
  './time/filter-model.js?v=0.33.3',
  './time/app.js?v=0.33.3',
  './time/styles.css?v=0.33.3',
  './time/home-layout.css?v=0.33.3',
  './time/home-layout.js?v=0.33.3',
  './time/home-top.css?v=0.33.3',
  './time/home-top.js?v=0.33.3',
  './time/removal-policy-ui.js?v=0.33.3'
];
