const CACHE='kmreg-test-shell-0.33.2';
const SHELL=[
  './',
  './index.html',
  './swipe-policy.js?v=0.33.2',
  './swipe-ui.css?v=0.33.2',
  './cards.css?v=0.33.2',
  './log-code.js?v=0.33.2',
  './cards.js?v=0.33.2',
  './people.js?v=0.33.2',
  './contact-import.js?v=0.33.2',
  './people.css?v=0.33.2',
  ...
  './log-ui.css?v=0.33.2',
  './removal-policy.js?v=0.33.2',
  './shell-backup-archive.js?v=0.33.2',
  './shell-ui.js?v=0.33.2',
  './shell-ui-stable.js?v=0.33.2',
  './shell-gestures.js?v=0.33.2',
  './shell-location-status.js?v=0.33.2',
  './shell-removal-policy.js?v=0.33.2',
  './shell-quick-actions.js?v=0.33.2',
  './shell-direct-actions.js?v=0.33.2',
  './id-converter.html',
  './manifest.webmanifest',
  './app-icon.svg',
  './config/modules.json',
  './time/index.html',
  './time/filter-model.js?v=0.33.2',
  './time/app.js?v=0.33.2',
  './time/styles.css?v=0.33.2',
  './time/home-layout.css?v=0.33.2',
  './time/home-layout.js?v=0.33.2',
  './time/home-top.css?v=0.33.2',
  './time/home-top.js?v=0.33.2',
  './time/removal-policy-ui.js?v=0.33.2'
];
