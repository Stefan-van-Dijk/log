const CACHE='kmreg-test-shell-0.31.10-test.117';
const SHELL=[
  './',
  './index.html',
  './swipe-policy.js?v=0.31.10-test.117',
  './swipe-ui.css?v=0.31.10-test.117',
  './cards.css?v=0.31.10-test.117',
  './cards.js?v=0.31.10-test.117',
  './vendor/qrcode-2.0.4.js',
  './vendor/jsbarcode-3.12.1.min.js',
  './vendor/zxing-0.21.3.min.js',
  './log-json-v2.js?v=2.0.0',
  './log-ui.css?v=0.31.10-test.117',
  './removal-policy.js?v=0.31.10-test.117',
  './shell-backup-archive.js?v=0.31.10-test.117',
  './shell-ui.js?v=0.31.10-test.117',
  './shell-ui-stable.js?v=0.31.10-test.117',
  './shell-gestures.js?v=0.31.10-test.117',
  './shell-location-status.js?v=0.31.10-test.117',
  './shell-removal-policy.js?v=0.31.10-test.117',
  './shell-quick-actions.js?v=0.31.10-test.117',
  './shell-direct-actions.js?v=0.31.10-test.117',
  './id-converter.html',
  './manifest.webmanifest',
  './app-icon.svg',
  './config/modules.json',
  './time/index.html',
  './time/filter-model.js?v=0.31.10-test.117',
  './time/app.js?v=0.31.10-test.117',
  './time/styles.css?v=0.31.10-test.117',
  './time/home-layout.css?v=0.31.10-test.117',
  './time/home-layout.js?v=0.31.10-test.117',
  './time/home-top.css?v=0.31.10-test.117',
  './time/home-top.js?v=0.31.10-test.117',
  './time/removal-policy-ui.js?v=0.31.10-test.117'
];
