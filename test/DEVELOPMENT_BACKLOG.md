...
| BAR-001 | Barcode/QR-code scannen | Testen | Camera of foto gebruiken om barcodes en QR-codes te lezen, inhoud controleren en opslaan. | Test .113: lokale ZXing-decoder; camera stopt bij sluiten, modulewisseling en achtergrond. Permission-denial en late camera-response gecontroleerd; echte iPhone-camera nog testen. |
